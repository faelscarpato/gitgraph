    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="mt-3 text-xl font-semibold tracking-tight text-foreground">
          The analyzer stopped unexpectedly
        </h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Try again, or return home and start a new analysis.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()(
  {
    head: () => ({
      meta: [
        ...
        { title: "GenIA Analyzer — Interactive code knowledge graph" },
        {
          name: "description",
          content:
            "Turn any GitHub repository into an interactive knowledge graph. Explore modules, dependencies and complexity — export the analysis to reuse with any AI agent.",
        },
        { name: "author", content: "GenIA Analyzer" },
        {
          property: "og:title",
          content: "GenIA Analyzer — Interactive code knowledge graph",
        },
        {
