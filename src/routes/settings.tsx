...
} from "@/lib/providers/local-agents";
import type {
  ProviderProfile,
  ProviderTestResult,
      ...
      <main className="mx-auto max-w-4xl px-6 py-8 space-y-10">
        <section>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Configure any OpenAI-compatible endpoint. Multiple profiles are
            supported — one is active at a time. Values are stored only in this
            browser.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Detects OpenAI-compatible servers on well-known localhost ports
            (Ollama, LM Studio, opencode, Claude Code, codex, gemini, hermes).
            Detection requires the agent to expose an HTTP endpoint; some CLIs
            do not — nothing to import in that case.
          </p>
          {probes && (
        ...
        <section className="surface-panel p-5">
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Anonymous requests to GitHub are limited to 60/hour. Adding a
            fine-grained personal token raises this to 5000/hour. Public-repo
            read is enough — no write scopes needed.
          </p>
